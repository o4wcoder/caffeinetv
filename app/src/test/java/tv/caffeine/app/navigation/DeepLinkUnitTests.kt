...
class DeepLinkUnitTests(private val url: String, @IdRes private val destination: Int) {
    ...
    companion object {
        ...
        fun data() = listOf(
                ...
                arrayOf("https://www.caffeine.tv/ESL", R.id.stageFragment),
                arrayOf("https://www.caffeine.tv/ESL/profile", R.id.profileFragment),
                arrayOf("https://www.caffeine.tv/caffeine", R.id.stageFragment),
                arrayOf("https://www.caffeine.tv/caffeine?bst=sharing", R.id.stageFragment),
