...
class NewReyes {
    ...
    class Feed(val id: String, val client_id: String, val role: Role, val description: String, val volume: Number, val is_hostable: Boolean, val source_connection_quality: String, val content: Content?, val capabilities: Capabilities, val hostable_address: String, val external_address: String, val stream: Stream) {
