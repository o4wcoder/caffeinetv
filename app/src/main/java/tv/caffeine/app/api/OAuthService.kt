...
interface OAuthService {
    ...
    fun authenticateWith(@Path("provider") provider: OAuthProvider): Deferred<CaffeineOAuthResponse>
...
@Parcelize
data class OAuthDetails(val uid: String, val provider: OAuthProvider, val displayName: String, val username: String?, val email: String?, val iid: String) : Parcelable
